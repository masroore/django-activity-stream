...
def followers(request, content_type_id, object_id):
    ...
    return render(request, 'actstream/followers.html',
                  context={'followers': models.followers(instance), 'actor': instance})
...
def following(request, user_id):
    ...
    return render(request, 'actstream/following.html',
                  context={'following': models.following(instance), 'user': instance})
...
def detail(request, action_id):
    ...
    return render(request, 'actstream/detail.html',
                  context={'action': get_object_or_404(models.Action, pk=action_id)})
...
def actor(request, content_type_id, object_id):
    ...
    instance = get_object_or_404(ctype.model_class(), pk=object_id)
    return render(request, 'actstream/actor.html',
                  context={'action_list': models.actor_stream(instance),
                           'actor': instance,
                           'ctype': ctype})
...
def model(request, content_type_id):
    ...
    return render(request, 'actstream/actor.html',
                  context={'action_list': models.model_stream(model_class),
                           'ctype': ctype,
                           'actor': model_class})
